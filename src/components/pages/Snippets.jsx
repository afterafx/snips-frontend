...
class Snippets extends Component {
  ...
  async componentDidMount() {
    ...
    const { data } = await axios.get('http://baktiar-snips-app.herokuapp.com/api/snippets');
  ...
  fetchSnippets = async searchText => {
    ...
    const { data: snippets } = await axios.get('http://baktiar-snips-app.herokuapp.com/api/snippets');
